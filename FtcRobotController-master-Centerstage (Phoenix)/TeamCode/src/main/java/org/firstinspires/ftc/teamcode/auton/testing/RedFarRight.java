...
public class RedFarRight extends LinearOpMode {
    ...
    private SpikeDetectionRed sleeveDetection;
    OpenCvCamera camera;
...
//                .waitSeconds(2)
                .lineToLinearHeading(new Pose2d(38,-60))
                .forward(24)
                .build();
...
//                .waitSeconds(2)
        ...
        sleeveDetection = new SpikeDetectionRed();
        ...
        while(!isStarted()) {
            ...
            closeClaw();
            wristUp();
            one = sleeveDetection.getPosition() == SpikeDetectionRed.SpikePosition.LEFT;
            two = sleeveDetection.getPosition() == SpikeDetectionRed.SpikePosition.CENTER;
